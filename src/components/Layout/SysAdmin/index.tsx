...
const SysAdminLayout = (props: LayoutProps) => {
  ...
  const menuItems = [
    {
      ...
      color: pathLocation === "/sysAdmin/dashboard" ? "#d2435e" : ""
    },
   
    
    {
      label: "Prisons",
      link: "/sysAdmin/prisons",
      color: pathLocation === "/sysAdmin/prisons" || pathLocation === "/sysAdmin/prisons" ? "#d2435e" : ""
    },
