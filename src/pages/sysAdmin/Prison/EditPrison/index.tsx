...
import { createPrison, getPrison } from "../../../../store/SysAdmin/Prison/actions";
import UpdatePrison from "../../../../components/SysAdmin/Prison/UpdatePrison";
  ...
  const EditPrison = () => {
    const { prison }: { prison: IStatePrison } = useSelector(
