...
import UpdateMaterial from "../../../../components/ItAdmin/Material/UpdateMaterial";
...
const statuses = [
  ...
  const EditMaterial = () => {
    const { material }: { material: IStateMaterial } = useSelector(
    ...
    const onSubmit = (e: FormEvent) => {
      ...
      dispatch(UpdateMaterial(params.id,data));
